 ...
 *
 */
public class Cubareason_Release3_app_DTC_Savedetails3 
{
	...
	
    {
		...
		database_operation.config = new properties_handle
				("Q:/Automation Team/1 Projects/08 DTC/Release4/SaveCustomer_FindConsumer/configuration_file/config_json_save3.properties");
