package Release4_SaveCustomer_FindConsumer;
 ...
 *
 */
public class Cubareason_Release3_app_DTC_Savedetails4 
{
	...
	
    {
		...
		database_operation.config = new properties_handle
				("Q:/Automation Team/1 Projects/08 DTC/Release4/SaveCustomer_FindConsumer/configuration_file/config_json_save4.properties");
				...
				for(int i=0;i<actual_column_size;i++)
				{
					...
					if(status_code.equals("SUCCESS"))
					{
						try
						{
							...
							System.out.println(actual_column_col[i]);
